...
for (var i = 0; i < issues.length; i++) {
    ...
    // target = _blank attribute lets webpage know to open link in a new tab instead of replacing the current webpage
...
// warning function if > 30 issues
var displayWarning = function(repo) {
    // add text to warning container
    limitWarningEl.textContent = "To see more than 30 issues, ";
    var linkEl = document.createElement("a");
    linkEl.textContent = " visit this repository on GitHub.com";
